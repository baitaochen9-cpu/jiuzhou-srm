 ...
 * 标准单据收回的BP
 */
public class AceLabelprintUnSendApproveBP {

	public AggLabelPrintHVO[] unSend(AggLabelPrintHVO[] clientBills,
	...
	private void setHeadVOStatus(AggLabelPrintHVO[] clientBills) {

...
import nc.ui.mmpac.pickm.model.PickmManageModel;
import nc.ui.mmpac.pickm.view.PickmBillForm;
...
public class TmprintAction extends NCAction{
	private PickmBillForm editorModel;
	private PickmManageModel model;
	...
	public void doAction(ActionEvent e) throws Exception {
        ...
        for (int i = 0; i < selectRows.length; i ++){
        	Object o = this.getEditorModel().
        			getBillCardPanel().getBillModel().getValueAt(selectRows[i], "cpickm_bid");
...
//        SFClientUtil.openNodeLinkedADD("40H120", querydata);
	...
	public PickmBillForm getEditorModel() {
		return editorModel;
	}
	public void setEditorModel(PickmBillForm editorModel) {
		this.editorModel = editorModel;
	}
	public PickmManageModel getModel() {
		return model;
	}
	public void setModel(PickmManageModel model) {
		this.model = model;
	}
}

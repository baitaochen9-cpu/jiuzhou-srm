...
public class PoPayPlanSender extends AbstractSender4OA {
	 ...
	 * @param listMaps
	 */
	private String  Convert2OA_Value(HashMap<String,Object> headMap,List<HashMap<String,Object>> listMaps) throws DAOException {
		// 主字段// 字段信息
		...
		for (HashMap<String, Object> bodyMap : listMaps) {
		  ...
		  Map<String, Object> oaParms = qry.getOaParms("popay");
		  rowfirst.put("tableDBName", oaParms.get("mnecode"));

 ...
 */
public class OA_getStordoc extends AbstracAdapter4Ext{
	...
	private List<Map<String, Object>> queryRespData(JSONObject rqJosn) throws DAOException, UnsupportedEncodingException {
		...
		List<Map<String,Object>> respData = null;  
		String org_code = rqJosn.getString("org_code");
		
		//查询语句
		String sql=" select * from VIEW_JZ_STORDOC where 1=1 ";
		
		sql = sql + " and orgcode = '"+ org_code +"'";

...
public class SupplierqualityHVO extends SuperVO {
...
* 创建日期:2020-12-25
* @param newPk_parent nc.vo.bd.supplier.supplierclass.SupplierclassVO
*/
...
/**
* 属性 pk_supplierquality的Getter方法.属性名：id
*  创建日期:2020-12-25
...
/**
* 属性pk_supplierquality的Setter方法.属性名：id
* 创建日期:2020-12-25
* @param newPk_supplierquality java.lang.String
*/
...
/**
* 属性 pk_grade_info的Getter方法.属性名：等级
*  创建日期:2020-12-25
...
/**
* 属性pk_grade_info的Setter方法.属性名：等级
* 创建日期:2020-12-25
* @param newPk_grade_info nc.vo.bd.supplier.suppliergradesys.SupplierGradeVO
*/
...
/**
* 属性 pk_suppliergrade的Getter方法.属性名：供应商等级体系
*  创建日期:2020-12-25
...
/**
* 属性pk_suppliergrade的Setter方法.属性名：供应商等级体系
* 创建日期:2020-12-25
* @param newPk_suppliergrade nc.vo.bd.supplier.suppliergradesys.SupplierGradeSysVO
*/
...
/**
* 属性 pk_vendor的Getter方法.属性名：生产厂商
*  创建日期:2020-12-25
...
/**
* 属性pk_vendor的Setter方法.属性名：生产厂商
* 创建日期:2020-12-25
* @param newPk_vendor nc.vo.bd.defdoc.DefdocVO
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("qc.supplierquality");
    }
   }

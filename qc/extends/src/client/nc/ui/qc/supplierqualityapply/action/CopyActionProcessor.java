package nc.ui.qc.supplierqualityapply.action;
...
public class CopyActionProcessor implements
		ICopyActionProcessor<AggSupplierQualityApplyVO> {

	@Override
	public void processVOAfterCopy(AggSupplierQualityApplyVO paramT,

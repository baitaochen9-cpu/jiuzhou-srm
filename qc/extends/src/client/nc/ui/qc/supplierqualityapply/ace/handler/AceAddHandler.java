package nc.ui.qc.supplierqualityapply.ace.handler;
...
public class AceAddHandler implements IAppEventHandler<AddEvent> {
	...
	public void handleAppEvent(AddEvent e) {
		...
		panel.setHeadItem("billtype", "C060");
		panel.setHeadItem("transtype", "C060");
		panel.setHeadItem("transtypepk",
				PfServiceScmUtil.getTrantypeidByCode(new String[] { "C060" })
						.get("C060"));

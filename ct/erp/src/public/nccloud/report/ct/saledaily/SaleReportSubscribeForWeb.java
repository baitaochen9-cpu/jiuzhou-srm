...
/**
 * @description 销售合同汇总查询报表
 * @author cuijun
 * @date 2018-5-24 上午10:04:40
 * @version ncc1.0
 */
public class SaleReportSubscribeForWeb implements IReportAdjustorForWeb {

	@Override
	public IQueryConditionProcessor getConditionProcessor(IContext context, AnaReportModel reportModel) {
		return new SaleReportSubscribeProcessor();
	}
	 ...
	 /**
	  ...
	  public String[] getHideKeys(ConditionVO[] conditions) {
	    ...
	    if (CtReportGroupEnum.MAR.value().equals(code)) {
	      /**
	       * 隐藏字段：合同类型,合同编码,合同名称,签订日期,客户,人员,部门,换算率、订单号、订单日期、订单物料编码、订单物料名称
	       */
	      return new String[] {
	        CtAbstractVO.VTRANTYPECODE, CtAbstractVO.VBILLCODE,
	        CtAbstractVO.CTNAME, CtAbstractVO.SUBSCRIBEDATE, CtSaleVO.PK_CUSTOMER,
	        CtAbstractVO.PERSONNELID, CtAbstractVO.DEPID_V, CtAbstractBVO.CROWNO,
	        CtAbstractBVO.VCHANGERATE, CtSaleSubQryInfoPara.DBILLDATE,
	        CtSaleSubQryInfoPara.VBILLCODE1, CtSaleSubQryInfoPara.CMATERIALVID,
	        CtAbstractBVO.PK_FINANCEORG_V
	      };
	    }
	    /** 物料+部门 **/
	    else if (CtReportGroupEnum.MARDPT.value().equals(code)) {
	      /**
	       * 隐藏字段：合同类型,合同编码,合同名称,签订日期,客户,人员,换算率、订单号、订单日期、订单物料编码、订单物料名称
	       */
	      return new String[] {
	        CtAbstractVO.VTRANTYPECODE, CtAbstractVO.VBILLCODE,
	        CtAbstractVO.CTNAME, CtAbstractVO.SUBSCRIBEDATE, CtSaleVO.PK_CUSTOMER,
	        CtAbstractVO.PERSONNELID, CtAbstractBVO.CROWNO,
	        CtAbstractBVO.VCHANGERATE, CtSaleSubQryInfoPara.DBILLDATE,
	        CtSaleSubQryInfoPara.VBILLCODE1, CtSaleSubQryInfoPara.CMATERIALVID,
	        CtAbstractBVO.PK_FINANCEORG_V
	      };
	    ...
	    /** 物料+客户 **/
	      ...
	      /**
	       * 隐藏字段：合同类型,合同编码,合同名称,签订日期,人员,部门,换算率、订单号、订单日期、订单物料编码、订单物料名称
	       */
	      return new String[] {
	        CtAbstractVO.VTRANTYPECODE, CtAbstractVO.VBILLCODE,
	        CtAbstractVO.CTNAME, CtAbstractVO.SUBSCRIBEDATE,
	        CtAbstractVO.PERSONNELID, CtAbstractVO.DEPID_V, CtAbstractBVO.CROWNO,
	        CtAbstractBVO.VCHANGERATE, CtSaleSubQryInfoPara.DBILLDATE,
	        CtSaleSubQryInfoPara.VBILLCODE1, CtSaleSubQryInfoPara.CMATERIALVID,
	        CtAbstractBVO.PK_FINANCEORG_V
	    ...
	    /** 物料+客户+部门 **/
	      ...
	      return new String[] {
	        CtAbstractVO.VTRANTYPECODE, CtAbstractVO.VBILLCODE,
	        CtAbstractVO.CTNAME, CtAbstractVO.SUBSCRIBEDATE,
	        CtAbstractVO.PERSONNELID, CtAbstractVO.BSC, CtAbstractBVO.CROWNO,
	        CtAbstractBVO.VCHANGERATE, CtSaleSubQryInfoPara.DBILLDATE,
	        CtSaleSubQryInfoPara.VBILLCODE1, CtSaleSubQryInfoPara.CMATERIALVID,
	        CtAbstractBVO.PK_FINANCEORG_V
	      };
	    ...
	    /** 明细 **/
	       ...
	       */
	      return new String[] {
	        CtAbstractVO.CORIGCURRENCYID, CtAbstractBVO.PK_FINANCEORG_V};
	    }
	    }
			return null;
	  }

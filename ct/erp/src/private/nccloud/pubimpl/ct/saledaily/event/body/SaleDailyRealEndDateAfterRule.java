 ...
 * @description 实际到期日
 * @author wangshrc
 * @date 2019年2月15日 上午11:10:03
 * @version ncc1.0
 */
public class SaleDailyRealEndDateAfterRule implements
	...
	public AggCtSaleVO afterEdit(AggCtSaleVO billvo,
		...
		if (enddate != null && effectdate != null && enddate.before(effectdate)) {
			bvos[row].setDrealenddate(null);
			userobject.put("errMsg", NCLangRes4VoTransl.getNCLangRes()
					.getStrByID("4020003_0", "04020003-0395")/*
															 * 实际到期日必须大于起效日
															 */
			);
		}

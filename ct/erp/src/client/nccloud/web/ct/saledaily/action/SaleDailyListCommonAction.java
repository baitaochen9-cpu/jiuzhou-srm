...
/**
 * @description 销售合同通用action
 * @author wangshrc
 * @date 2019年1月23日 下午2:37:27
 * @version ncc1.0
 */
public abstract class SaleDailyListCommonAction extends AbstractGridAction<AggCtSaleVO> {
	...
	protected Object action(AggCtSaleVO[] vos) {
		...
		SCMBatchOperatorResult result = new SCMBatchOperatorResult(dto, "400600200_list");
		Grid grid = result.getSucessVOs();
		if (grid != null)

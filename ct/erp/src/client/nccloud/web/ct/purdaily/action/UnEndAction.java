 ...
 * @description 取消终止
 * @author xiahui
 * @date 创建时间：2019-1-18 上午8:47:31 
 * @version ncc1.0 
 **/
public class UnEndAction extends BaseScriptAction {
	...
	public void beforeProcess(Object[] objs, Map<String, Object> userObj) {
		...
		ScriptActionUtil.addNewExecVO((AbstractBill[]) objs, CtFlowEnum.TERMINATE.toIntValue(), reason,
				ScriptActionUtil.getUNTERMINATE());
	}

	@Override
	public SCMScriptResultDTO execScript(AbstractBill[] bills) {
		CloudPFlowContext context = new CloudPFlowContext();
		context.setActionName("UNTERMINATE");

...
public class DefdocTransAndStoreRefModel extends AbstractRefModel {
     DefdocDefaultModelUtil util = new DefdocDefaultModelUtil();

    public DefdocTransAndStoreRefModel() {
        super();
    }
    ...
    public void reset() {
        this.setFieldCode(new String[] {
            DefdocVO.CODE, DefdocVO.NAME, DefdocVO.MEMO, DefdocVO.MNECODE ,DefdocVO.DEF1,DefdocVO.DEF2,DefdocVO.DEF3,DefdocVO.DEF5,DefdocVO.DEF6
        });
        this.setFieldName(new String[] {
            NCLangRes4VoTransl.getNCLangRes().getStrByID("common",
                    "UC000-0003279")/* "编码" */,
                    /* NCLangRes4VoTransl.getNCLangRes().getStrByID("common",
                    "UC000-0001155")  "名称" */"储存条件",
            NCLangRes4VoTransl.getNCLangRes().getStrByID("common",
                    "UC000-0001376")
            /* 备注 */,
            NCLangRes4VoTransl.getNCLangRes().getStrByID("common",

...
/*      */
/*      */public class MaterialVersionVO extends SuperVO
/*      */{
	...
	/*  184 */private Integer dataoriginflag = Integer.valueOf(0);
	/*      */private String def1;
	...
	/*  228 */private Integer dr = Integer.valueOf(0);
	...
	/*      */{
		/*  396 */return this.dataoriginflag;
		/*      */}
	/*      */
	/*      */public String getDef1()
	/*      */{
		/*  406 */return this.def1;
		/*      */}
	/*      */
	/*      */public String getDef10()
	/*      */{
		/*  416 */return this.def10;
		/*      */}
	/*      */
	/*      */public String getDef11()
	/*      */{
		/*  426 */return this.def11;
		/*      */}
	/*      */
	/*      */public String getDef12()
	/*      */{
		/*  436 */return this.def12;
		/*      */}
	/*      */
	/*      */public String getDef13()
	/*      */{
		/*  446 */return this.def13;
		/*      */}
	/*      */
	/*      */public String getDef14()
	/*      */{
		/*  456 */return this.def14;
		/*      */}
	/*      */
	/*      */public String getDef15()
	/*      */{
		/*  466 */return this.def15;
		/*      */}
	/*      */
	/*      */public String getDef16()
	/*      */{
		/*  476 */return this.def16;
		/*      */}
	/*      */
	/*      */public String getDef17()
	/*      */{
		/*  486 */return this.def17;
		/*      */}
	/*      */
	/*      */public String getDef18()
	/*      */{
		/*  496 */return this.def18;
		/*      */}
	/*      */
	/*      */public String getDef19()
	/*      */{
		/*  506 */return this.def19;
		/*      */}
	/*      */
	/*      */public String getDef2()
	/*      */{
		/*  516 */return this.def2;
		/*      */}
	/*      */
	/*      */public String getDef20()
	/*      */{
		/*  526 */return this.def20;
		/*      */}
	/*      */
	/*      */public String getDef3()
	/*      */{
		/*  536 */return this.def3;
		/*      */}
	/*      */
	/*      */public String getDef4()
	/*      */{
		/*  546 */return this.def4;
		/*      */}
	/*      */
	/*      */public String getDef5()
	/*      */{
		/*  556 */return this.def5;
		/*      */}
	/*      */
	/*      */public String getDef6()
	/*      */{
		/*  566 */return this.def6;
		/*      */}
	/*      */
	/*      */public String getDef7()
	/*      */{
		/*  576 */return this.def7;
		/*      */}
	/*      */
	/*      */public String getDef8()
	/*      */{
		/*  586 */return this.def8;
		/*      */}
	/*      */
	/*      */public String getDef9()
	/*      */{
		/*  596 */return this.def9;
		/*      */}
	/*      */
	/*      */public UFBoolean getDiscountflag()
	/*      */{
		/*  606 */return this.discountflag;
		/*      */}
	/*      */
	...
	/*      */{
		/*  626 */return this.electronicsale;
		/*      */}
	/*      */
	/*      */public Integer getEnablestate()
	/*      */{
		/*  636 */return this.enablestate;
		/*      */}
	/*      */
	...
	/*      */{
		/*  656 */return this.graphid;
		/*      */}
	/*      */
	/*      */public UFDouble getIntolerance()
	/*      */{
		/*  666 */return this.intolerance;
		/*      */}
	/*      */
	/*      */public UFBoolean getIselectrans()
	/*      */{
		/*  676 */return this.iselectrans;
		/*      */}
	/*      */
	/*      */public String getMaterialbarcode()
	/*      */{
		/*  686 */return this.materialbarcode;
		/*      */}
	/*      */
	/*      */public Integer getMaterialmgt()
	/*      */{
		/*  696 */return this.materialmgt;
		/*      */}
	/*      */
	/*      */public String getMaterialmnecode()
	/*      */{
		/*  706 */return this.materialmnecode;
		/*      */}
	/*      */
	/*      */public String getMaterialshortname()
	/*      */{
		/*  716 */return this.materialshortname;
		/*      */}
	/*      */
	/*      */public String getMaterialspec()
	/*      */{
		/*  726 */return this.materialspec;
		/*      */}
	/*      */
	/*      */public String getMaterialtype()
	/*      */{
		/*  736 */return this.materialtype;
		/*      */}
	/*      */
	/*      */public String getMemo()
	/*      */{
		/*  746 */return this.memo;
		/*      */}
	/*      */
	/*      */public UFDateTime getModifiedtime()
	/*      */{
		/*  756 */return this.modifiedtime;
		/*      */}
	/*      */
	...
	/*      */{
		/*  786 */return this.name2;
		/*      */}
	/*      */
	/*      */public String getName3()
	/*      */{
		/*  796 */return this.name3;
		/*      */}
	/*      */
	/*      */public String getName4()
	/*      */{
		/*  806 */return this.name4;
		/*      */}
	/*      */
	/*      */public String getName5()
	/*      */{
		/*  816 */return this.name5;
		/*      */}
	/*      */
	/*      */public String getName6()
	/*      */{
		/*  826 */return this.name6;
		/*      */}
	/*      */
	/*      */public UFDouble getOutcloselowerlimit()
	/*      */{
		/*  836 */return this.outcloselowerlimit;
		/*      */}
	/*      */
	/*      */public UFDouble getOuttolerance()
	/*      */{
		/*  846 */return this.outtolerance;
		/*      */}
	/*      */
	...
	/*      */{
		/*  869 */return this.pk_brand;
		/*      */}
	/*      */
	/*      */public String getPk_goodscode()
	/*      */{
		/*  879 */return this.pk_goodscode;
		/*      */}
	/*      */
	/*      */public String getPk_group()
	/*      */{
		/*  889 */return this.pk_group;
		/*      */}
	/*      */
	/*      */public String getPk_marasstframe()
	/*      */{
		/*  899 */return this.pk_marasstframe;
		/*      */}
	/*      */
	/*      */public String getPk_marbasclass()
	/*      */{
		/*  909 */return this.pk_marbasclass;
		/*      */}
	/*      */
	/*      */public String getPk_material()
	/*      */{
		/*  919 */return this.pk_material;
		/*      */}
	/*      */
	/*      */public String getPk_material_pf()
	/*      */{
		/*  929 */return this.pk_material_pf;
		/*      */}
	/*      */
	/*      */public String getPk_mattaxes()
	/*      */{
		/*  939 */return this.pk_mattaxes;
		/*      */}
	/*      */
	/*      */public String getPk_measdoc()
	/*      */{
		/*  949 */return this.pk_measdoc;
		/*      */}
	/*      */
	/*      */public String getPk_org()
	/*      */{
		/*  959 */return this.pk_org;
		/*      */}
	/*      */
	/*      */public String getPk_prodline()
	/*      */{
		/*  969 */return this.pk_prodline;
		/*      */}
	/*      */
	/*      */public String getPk_source()
	/*      */{
		/*  979 */return this.pk_source;
		/*      */}
	/*      */
	/*      */public String getPKFieldName()
	/*      */{
		/*  992 */return "pk_source";
		/*      */}
	/*      */
	/*      */public String getProdarea()
	/*      */{
		/* 1002 */return this.prodarea;
		/*      */}
	/*      */
	/*      */public UFBoolean getProductfamily()
	/*      */{
		/* 1012 */return this.productfamily;
		/*      */}
	/*      */
	/*      */public Integer getProlifeperiod()
	/*      */{
		/* 1022 */return this.prolifeperiod;
		/*      */}
	/*      */
	/*      */public UFBoolean getRetail()
	/*      */{
		/* 1032 */return this.retail;
		/*      */}
	/*      */
	/*      */public UFBoolean getSetpartsflag()
	/*      */{
		/* 1042 */return this.setpartsflag;
		/*      */}
	/*      */
	/*      */public UFDouble getStoreunitnum()
	/*      */{
		/* 1052 */return this.storeunitnum;
		/*      */}
	/*      */
	/*      */public String getTableName()
	/*      */{
		/* 1065 */return "bd_material_v";
		/*      */}
	/*      */
	...
	/*      */{
		/* 1825 */this.unitheight = newUnitheight;
		/*      */}
	/*      */
	/*      */public void setUnitlength(String newUnitlength)
	/*      */{
		/* 1835 */this.unitlength = newUnitlength;
		/*      */}
	/*      */
	/*      */public void setUnitvolume(UFDouble newUnitvolume)
	/*      */{
		/* 1845 */this.unitvolume = newUnitvolume;
		/*      */}
	/*      */
	/*      */public void setUnitweight(UFDouble newUnitweight)
	/*      */{
		/* 1855 */this.unitweight = newUnitweight;
		/*      */}
	/*      */
	/*      */public void setUnitwidth(String newUnitwidth)
	/*      */{
		/* 1865 */this.unitwidth = newUnitwidth;
		/*      */}
	/*      */
	/*      */public void setVersion(Integer newVersion)
	/*      */{
		/* 1875 */this.version = newVersion;
		/*      */}
	/*      */
	/*      */public void setEname(String ename) {
		/* 1879 */this.ename = ename;
		/*      */}
	/*      */
	/*      */public String getEname() {
		/* 1883 */return this.ename;
		/*      */}
	/*      */
	/*      */public void setEmaterialspec(String ematerialspec) {
		/* 1887 */this.ematerialspec = ematerialspec;
		/*      */}
	/*      */
	/*      */public String getEmaterialspec() {
		/* 1891 */return this.ematerialspec;
		/*      */}
	/*      */
	/*      */public void setGoodsprtname(String goodsprtname) {
		/* 1895 */this.goodsprtname = goodsprtname;
		/*      */}
	/*      */
	/*      */public String getGoodsprtname() {
		/* 1899 */return this.goodsprtname;
		/*      */}
	/*      */
	/*      */public UFBoolean getIshproitems() {
		/* 1903 */return this.ishproitems;
		/*      */}
	/*      */
	/*      */public void setIshproitems(UFBoolean ishproitems) {
		/* 1907 */this.ishproitems = ishproitems;
		/*      */}
	/*      */
	/*      */@MDEntityInfo(beanFullclassName = "nc.vo.bd.material.MaterialVersionVO")
	/*      */public IVOMeta getMetaData()
	/*      */{
		/* 1913 */return VOMetaFactory.getInstance().getVOMeta(
				"uap.material_v");
		/*      */}
	/*      */
	/*      */public UFBoolean getIsfeature()
	/*      */{
		/* 1918 */return this.isfeature;
		/*      */}
	/*      */
	/*      */public void setIsfeature(UFBoolean isfeature) {
		/* 1922 */this.isfeature = isfeature;
		/*      */}
	/*      */
	/*      */public String getFeatureclass() {
		/* 1926 */return this.featureclass;
		/*      */}
	/*      */
	/*      */public void setFeatureclass(String featureclass) {
		/* 1930 */this.featureclass = featureclass;
		/*      */}
	/*      */
	/*      */public Integer getMatchmode() {
		/* 1934 */return this.matchmode;
		/*      */}
	/*      */
	/*      */public void setMatchmode(Integer matchmode) {
		/* 1938 */this.matchmode = matchmode;
		/*      */}
	/*      */

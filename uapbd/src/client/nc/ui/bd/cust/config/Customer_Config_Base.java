...
public class Customer_Config_Base extends AbstractJavaBeanDefinition{
...
public nc.ui.bd.cust.baseinfo.editor.CustBaseInfoEditor getBaseinfoEditor(){
 ...
 return (nc.ui.bd.cust.baseinfo.editor.CustBaseInfoEditor)context.get("baseinfoEditor");
  ...
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_3952d6());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList7(){  List list = new ArrayList();  list.add(getCustContactsAddLineAction_5353dd());  list.add(getInsertLineAction_a6e0b2());  list.add(getDelLineAction_1e9d7e3());  return list;}

private nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction getCustContactsAddLineAction_5353dd(){
 if(context.get("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#5353dd")!=null)
 return (nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction)context.get("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#5353dd");
  nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction bean = new nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction();
  context.put("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#5353dd",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_a6e0b2(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#a6e0b2")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#a6e0b2");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#a6e0b2",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1e9d7e3(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1e9d7e3")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1e9d7e3");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1e9d7e3",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList8(){  List list = new ArrayList();  list.add(getAddLineAction_15cb69c());  list.add(getInsertLineAction_1d8f0c7());  list.add(getDelLineAction_1a7d649());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_15cb69c(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#15cb69c")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#15cb69c");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#15cb69c",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_1d8f0c7(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#1d8f0c7")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#1d8f0c7");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#1d8f0c7",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1a7d649(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1a7d649")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1a7d649");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1a7d649",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList9(){  List list = new ArrayList();  list.add(getAddLineAction_1e57552());  list.add(getInsertLineAction_1797b43());  list.add(getDelLineAction_8ba5e8());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1e57552(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1e57552")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1e57552");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1e57552",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_1797b43(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#1797b43")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#1797b43");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#1797b43",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_8ba5e8(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#8ba5e8")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#8ba5e8");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#8ba5e8",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_3952d6(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#3952d6")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#3952d6");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#3952d6",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.uif2.actions.QueryAction getQueryAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("queryAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_16d7127());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_16d7127(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16d7127")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16d7127");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16d7127",bean);
  bean.setContext(getContext());
...
private java.lang.String getI18nFB_1fe969(){
 if(context.get("nc.ui.uif2.I18nFB#1fe969")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1fe969");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1fe969",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1fe969",product);
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getFreeCustValidator_11519b2());  return list;}

private nc.bs.bd.cust.baseinfo.validator.FreeCustValidator getFreeCustValidator_11519b2(){
 if(context.get("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#11519b2")!=null)
 return (nc.bs.bd.cust.baseinfo.validator.FreeCustValidator)context.get("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#11519b2");
  nc.bs.bd.cust.baseinfo.validator.FreeCustValidator bean = new nc.bs.bd.cust.baseinfo.validator.FreeCustValidator();
  context.put("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#11519b2",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.cust.baseinfo.action.CreateSupplierSaveAction getCreateSupSaveAction(){
 ...
 return (nc.ui.bd.cust.baseinfo.action.CreateSupplierSaveAction)context.get("createSupSaveAction");
  ...
  bean.setBaseModel(getBaseinfoModel());
  bean.setValidationService(getDefaultValidationService_84c9b0());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.bs.uif2.validation.DefaultValidationService getDefaultValidationService_84c9b0(){
 if(context.get("nc.bs.uif2.validation.DefaultValidationService#84c9b0")!=null)
 return (nc.bs.uif2.validation.DefaultValidationService)context.get("nc.bs.uif2.validation.DefaultValidationService#84c9b0");
  nc.bs.uif2.validation.DefaultValidationService bean = new nc.bs.uif2.validation.DefaultValidationService();
  context.put("nc.bs.uif2.validation.DefaultValidationService#84c9b0",bean);
...
private List getManagedList17(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_4a00f4());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_4a00f4(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#4a00f4")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#4a00f4");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#4a00f4",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getCreateSupDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("createSupDlgBaseMediator");
  ...
  bean.setName(getI18nFB_1d5527d());
  bean.setModel(getCreateViewModel());
  bean.setEditor(getCreateSupView());
...
private java.lang.String getI18nFB_1d5527d(){
 if(context.get("nc.ui.uif2.I18nFB#1d5527d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1d5527d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1d5527d",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1d5527d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateSupDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateSupDlgBaseMediator");
  ...
  bean.setName(getI18nFB_1ac4e0());
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
  bean.setSaveAction(getAssociateSupplierSaveAction_1737736());
  bean.setCancelAction(getCancelAction_1978120());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_1ac4e0(){
 if(context.get("nc.ui.uif2.I18nFB#1ac4e0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1ac4e0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1ac4e0",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1ac4e0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction getAssociateSupplierSaveAction_1737736(){
 if(context.get("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#1737736")!=null)
 return (nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction)context.get("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#1737736");
  ...
  context.put("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#1737736",bean);
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
  bean.setBaseModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.CancelAction getCancelAction_1978120(){
 if(context.get("nc.ui.uif2.actions.CancelAction#1978120")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#1978120");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#1978120",bean);
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu_card(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu_card");
  ...
  bean.setName(getI18nFB_19e67f9());
...
private java.lang.String getI18nFB_19e67f9(){
 if(context.get("nc.ui.uif2.I18nFB#19e67f9")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#19e67f9");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#19e67f9",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#19e67f9",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_bc3b6c(){
 if(context.get("nc.ui.uif2.I18nFB#bc3b6c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#bc3b6c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#bc3b6c",bean);  bean.setResDir("common");
  bean.setDefaultValue("辅助功能");
  bean.setResId("UC001-0000137");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#bc3b6c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1526418());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1526418(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1526418")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1526418");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1526418",bean);
...
private List getManagedList26(){  List list = new ArrayList();  list.add(getHSNode_1ef18ab());  list.add(getVSNode_6bd498());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_1ef18ab(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#1ef18ab")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#1ef18ab");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#1ef18ab",bean);
  bean.setLeft(getCNode_1e16f6e());
  bean.setRight(getCNode_15ab43d());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1e16f6e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1e16f6e")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1e16f6e");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1e16f6e",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_15ab43d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#15ab43d")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#15ab43d");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#15ab43d",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_6bd498(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#6bd498")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#6bd498");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#6bd498",bean);
  bean.setUp(getCNode_3c88ab());
  bean.setDown(getVSNode_1236b94());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_3c88ab(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#3c88ab")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#3c88ab");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#3c88ab",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1236b94(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1236b94")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1236b94");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1236b94",bean);
  bean.setUp(getCNode_30d34c());
  bean.setDown(getId());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_30d34c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#30d34c")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#30d34c");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#30d34c",bean);
...
private List getManagedList27(){  List list = new ArrayList();  list.add(getCNode_c24876());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_c24876(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#c24876")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#c24876");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#c24876",bean);
  bean.setName(getI18nFB_1803f66());
...
private java.lang.String getI18nFB_1803f66(){
 if(context.get("nc.ui.uif2.I18nFB#1803f66")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1803f66");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1803f66",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1803f66",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_297bed());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_297bed(){
 if(context.get("bdqueryActionBaseMediator.created#297bed")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#297bed");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#297bed",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setBaseEditor(getBaseinfoEditor());
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_1872aa4());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_1872aa4(){
 if(context.get("nc.ui.uif2.I18nFB#1872aa4")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1872aa4");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1872aa4",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
  bean.setResId("010140cub0037");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1872aa4",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

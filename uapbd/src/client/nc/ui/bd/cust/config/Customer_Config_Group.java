...
public nc.ui.bd.cust.baseinfo.editor.CustBaseInfoEditor getBaseinfoEditor(){
 ...
 return (nc.ui.bd.cust.baseinfo.editor.CustBaseInfoEditor)context.get("baseinfoEditor");
  ...
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_138d8f6());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList7(){  List list = new ArrayList();  list.add(getCustContactsAddLineAction_15763f2());  list.add(getInsertLineAction_62b4f1());  list.add(getDelLineAction_554bd9());  return list;}

private nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction getCustContactsAddLineAction_15763f2(){
 if(context.get("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#15763f2")!=null)
 return (nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction)context.get("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#15763f2");
  nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction bean = new nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction();
  context.put("nc.ui.bd.cust.baseinfo.action.CustContactsAddLineAction#15763f2",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_62b4f1(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#62b4f1")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#62b4f1");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#62b4f1",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_554bd9(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#554bd9")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#554bd9");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#554bd9",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList8(){  List list = new ArrayList();  list.add(getAddLineAction_1e6d45b());  list.add(getInsertLineAction_17fab8b());  list.add(getDelLineAction_d7585f());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1e6d45b(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1e6d45b")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1e6d45b");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1e6d45b",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_17fab8b(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#17fab8b")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#17fab8b");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#17fab8b",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_d7585f(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#d7585f")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#d7585f");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#d7585f",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList9(){  List list = new ArrayList();  list.add(getAddLineAction_1eaf497());  list.add(getInsertLineAction_600543());  list.add(getDelLineAction_1f9780d());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1eaf497(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1eaf497")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1eaf497");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1eaf497",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_600543(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#600543")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#600543");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#600543",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1f9780d(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1f9780d")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1f9780d");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1f9780d",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_138d8f6(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#138d8f6")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#138d8f6");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#138d8f6",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.uif2.actions.QueryAction getQueryAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("queryAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_12c3fba());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_12c3fba(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#12c3fba")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#12c3fba");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#12c3fba",bean);
  bean.setContext(getContext());
...
private java.lang.String getI18nFB_c0454(){
 if(context.get("nc.ui.uif2.I18nFB#c0454")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c0454");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c0454",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#c0454",product);
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getFreeCustValidator_f06251());  return list;}

private nc.bs.bd.cust.baseinfo.validator.FreeCustValidator getFreeCustValidator_f06251(){
 if(context.get("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#f06251")!=null)
 return (nc.bs.bd.cust.baseinfo.validator.FreeCustValidator)context.get("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#f06251");
  nc.bs.bd.cust.baseinfo.validator.FreeCustValidator bean = new nc.bs.bd.cust.baseinfo.validator.FreeCustValidator();
  context.put("nc.bs.bd.cust.baseinfo.validator.FreeCustValidator#f06251",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.cust.baseinfo.action.CreateSupplierSaveAction getCreateSupSaveAction(){
 ...
 return (nc.ui.bd.cust.baseinfo.action.CreateSupplierSaveAction)context.get("createSupSaveAction");
  ...
  bean.setBaseModel(getBaseinfoModel());
  bean.setValidationService(getDefaultValidationService_d3a456());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.bs.uif2.validation.DefaultValidationService getDefaultValidationService_d3a456(){
 if(context.get("nc.bs.uif2.validation.DefaultValidationService#d3a456")!=null)
 return (nc.bs.uif2.validation.DefaultValidationService)context.get("nc.bs.uif2.validation.DefaultValidationService#d3a456");
  nc.bs.uif2.validation.DefaultValidationService bean = new nc.bs.uif2.validation.DefaultValidationService();
  context.put("nc.bs.uif2.validation.DefaultValidationService#d3a456",bean);
...
private List getManagedList17(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_1c6d525());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_1c6d525(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1c6d525")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1c6d525");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1c6d525",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private java.lang.String getI18nFB_ca3bc3(){
 if(context.get("nc.ui.uif2.I18nFB#ca3bc3")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#ca3bc3");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#ca3bc3",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#ca3bc3",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateSupDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateSupDlgBaseMediator");
  ...
  bean.setName(getI18nFB_119b3ed());
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
  bean.setSaveAction(getAssociateSupplierSaveAction_73c17c());
  bean.setCancelAction(getCancelAction_1a3d90d());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_119b3ed(){
 if(context.get("nc.ui.uif2.I18nFB#119b3ed")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#119b3ed");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#119b3ed",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#119b3ed",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction getAssociateSupplierSaveAction_73c17c(){
 if(context.get("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#73c17c")!=null)
 return (nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction)context.get("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#73c17c");
  ...
  context.put("nc.ui.bd.cust.baseinfo.action.AssociateSupplierSaveAction#73c17c",bean);
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
  bean.setBaseModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.CancelAction getCancelAction_1a3d90d(){
 if(context.get("nc.ui.uif2.actions.CancelAction#1a3d90d")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#1a3d90d");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#1a3d90d",bean);
  bean.setModel(getAssociateSupModel());
  bean.setEditor(getAssociateSupEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu_card(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu_card");
  ...
  bean.setName(getI18nFB_1fef8cf());
...
private java.lang.String getI18nFB_1fef8cf(){
 if(context.get("nc.ui.uif2.I18nFB#1fef8cf")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1fef8cf");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1fef8cf",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1fef8cf",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_811a8e(){
 if(context.get("nc.ui.uif2.I18nFB#811a8e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#811a8e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#811a8e",bean);  bean.setResDir("common");
  bean.setDefaultValue("辅助功能");
  bean.setResId("UC001-0000137");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#811a8e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList21(){  List list = new ArrayList();  list.add(getCreateSupplierAction());  list.add(getAssociateSupAction());  list.add(getBatchcreateSupplierAction());  list.add(getAccessoryAction());  return list;}
...
private List getManagedList22(){  List list = new ArrayList();  list.add(getCard_enableAction());  list.add(getCard_disableAction());  return list;}
...
private List getManagedList23(){  List list = new ArrayList();  list.add(getBaseinfoEnableAction());  list.add(getBaseinfoDisableAction());  return list;}
...
private List getManagedList24(){  List list = new ArrayList();  list.add(getCard_freezeaction());  list.add(getCard_unfreezeaction());  return list;}
...
private List getManagedList25(){  List list = new ArrayList();  list.add(getList_freezeaction());  list.add(getList_unfreezeaction());  return list;}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_12912a5());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_12912a5(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#12912a5")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#12912a5");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#12912a5",bean);
...
private List getManagedList26(){  List list = new ArrayList();  list.add(getHSNode_1f7f476());  list.add(getVSNode_17a503a());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_1f7f476(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#1f7f476")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#1f7f476");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#1f7f476",bean);
  bean.setLeft(getCNode_1f67c96());
  bean.setRight(getCNode_16d87f1());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1f67c96(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1f67c96")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1f67c96");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1f67c96",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_16d87f1(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#16d87f1")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#16d87f1");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#16d87f1",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_17a503a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#17a503a")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#17a503a");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#17a503a",bean);
  bean.setUp(getCNode_1d29b12());
  bean.setDown(getVSNode_d9bf6());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1d29b12(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1d29b12")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1d29b12");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1d29b12",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_d9bf6(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#d9bf6")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#d9bf6");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#d9bf6",bean);
  bean.setUp(getCNode_1c2bfc7());
  bean.setDown(getId());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c2bfc7(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1c2bfc7")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c2bfc7");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1c2bfc7",bean);
...
private List getManagedList27(){  List list = new ArrayList();  list.add(getCNode_ff96ec());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_ff96ec(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#ff96ec")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#ff96ec");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#ff96ec",bean);
  bean.setName(getI18nFB_bcd3f5());
...
private java.lang.String getI18nFB_bcd3f5(){
 if(context.get("nc.ui.uif2.I18nFB#bcd3f5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#bcd3f5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#bcd3f5",bean);  bean.setResDir("10140cub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#bcd3f5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_1871fa5());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_1871fa5(){
 if(context.get("bdqueryActionBaseMediator.created#1871fa5")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#1871fa5");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#1871fa5",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getBaseinfoEditorActions(){
 ...
 return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("baseinfoEditorActions");
  ...
  bean.setEditActions(getManagedList30());
  bean.setModel(getBaseinfoModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList29(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAddAction());  list.add(getBatchUpdateGroupAction());  list.add(getSeparatorAction());  list.add(getQueryAction());  list.add(getRefreshSingleAction());  list.add(getSeparatorAction());  list.add(getAssignActionGroup());  list.add(getBankaccAction());  list.add(getCustaddressAction());  list.add(getCard_freezegroupaction());  list.add(getCard_enableGroupAction());  list.add(getAssistantFuncMenu_card());  list.add(getSeparatorAction());  list.add(getOrgBrowseAction());  list.add(getOrgvisitAction());  list.add(getAssociatePfCustAction());  list.add(getSeparatorAction());  list.add(getPrintActionGroup());  list.add(getSeparatorAction());  list.add(getMdmAction());  return list;}

private List getManagedList30(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSaveAddAction());  list.add(getSeparatorAction());  list.add(getCancelAction());  return list;}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setBaseEditor(getBaseinfoEditor());
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_2e9199());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_2e9199(){
 if(context.get("nc.ui.uif2.I18nFB#2e9199")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#2e9199");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#2e9199",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
  bean.setResId("010140cub0037");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#2e9199",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList31(){  List list = new ArrayList();  list.add("pk_org");  return list;}

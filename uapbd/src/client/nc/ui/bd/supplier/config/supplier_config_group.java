...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryParam_19af221());  list.add(getQueryParam_18e5e95());  list.add(getQueryParam_1e39969());  list.add(getQueryParam_16cc191());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_19af221(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#19af221")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#19af221");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#19af221",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_18e5e95(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#18e5e95")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#18e5e95");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#18e5e95",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1e39969(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1e39969")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1e39969");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1e39969",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_16cc191(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#16cc191")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#16cc191");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#16cc191",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_85801d());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_85801d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#85801d")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#85801d");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#85801d",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getHSNode_4e3585());  list.add(getVSNode_a4dfa());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_4e3585(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#4e3585")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#4e3585");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#4e3585",bean);
  bean.setLeft(getCNode_1183618());
  bean.setRight(getCNode_8779cf());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1183618(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1183618")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1183618");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1183618",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_8779cf(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#8779cf")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#8779cf");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#8779cf",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_a4dfa(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#a4dfa")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#a4dfa");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#a4dfa",bean);
  bean.setUp(getCNode_9bb71f());
  bean.setDown(getVSNode_15d0d26());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_9bb71f(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#9bb71f")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#9bb71f");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#9bb71f",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_15d0d26(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#15d0d26")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#15d0d26");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#15d0d26",bean);
  bean.setUp(getCNode_1139529());
  bean.setDown(getTBNode_11e2249());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1139529(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1139529")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1139529");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1139529",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_11e2249(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#11e2249")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#11e2249");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#11e2249",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getCNode_1da8436());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1da8436(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1da8436")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1da8436");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1da8436",bean);
  bean.setName(getI18nFB_a5c7b6());
...
private java.lang.String getI18nFB_a5c7b6(){
 if(context.get("nc.ui.uif2.I18nFB#a5c7b6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#a5c7b6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#a5c7b6",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#a5c7b6",product);
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_9df343());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_9df343(){
 if(context.get("bdqueryActionBaseMediator.created#9df343")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#9df343");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#9df343",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView getBaseinfoListView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView)context.get("baseinfoListView");
  ...
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_1cdc783());
...
private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_1cdc783(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1cdc783")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1cdc783");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1cdc783",bean);
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView getBaseinfoCardView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView)context.get("baseinfoCardView");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setNodekey("base");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_e59056());
  bean.setExceptionHandler(getExceptionhandler());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_e59056(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#e59056")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#e59056");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#e59056",bean);
  bean.setContainer(getUserdefitemContainer());
...
private List getManagedList11(){  List list = new ArrayList();  list.add(getAddLineAction_1671834());  list.add(getInsertLineAction_1663e3d());  list.add(getDelLineAction_1805615());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1671834(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1671834")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1671834");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1671834",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_1663e3d(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#1663e3d")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#1663e3d");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#1663e3d",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1805615(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1805615")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1805615");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1805615",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getAddLineAction_93b8f7());  list.add(getInsertLineAction_547f33());  list.add(getDelLineAction_16af084());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_93b8f7(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#93b8f7")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#93b8f7");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#93b8f7",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_547f33(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#547f33")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#547f33");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#547f33",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_16af084(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#16af084")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#16af084");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#16af084",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.funcnode.ui.action.MenuAction getFilterAction(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("filterAction");
  ...
  bean.setCode("filter");
  bean.setName(getI18nFB_1d47518());
...
private java.lang.String getI18nFB_1d47518(){
 if(context.get("nc.ui.uif2.I18nFB#1d47518")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1d47518");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1d47518",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1d47518",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAction getList_searchAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("list_searchAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_1538afb());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_1538afb(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#1538afb")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#1538afb");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#1538afb",bean);
  bean.setContext(getContext());
...
private List getManagedList19(){  List list = new ArrayList();  list.add(getSupBaseInfoBatchUpdateTab_1c98016());  list.add(getSupFinanceBatchUpdateTab_1f865e5());  list.add(getSupStockBatchUpdateTab_e9a072());  return list;}

private nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab getSupBaseInfoBatchUpdateTab_1c98016(){
 if(context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1c98016")!=null)
 return (nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab)context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1c98016");
  nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab bean = new nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab();
  context.put("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1c98016",bean);
...
private nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab getSupFinanceBatchUpdateTab_1f865e5(){
 if(context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1f865e5")!=null)
 return (nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab)context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1f865e5");
  nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab bean = new nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab();
  context.put("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1f865e5",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.stock.SupStockBatchUpdateTab getSupStockBatchUpdateTab_e9a072(){
 if(context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#e9a072")!=null)
 return (nc.ui.bd.supplier.stock.SupStockBatchUpdateTab)context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#e9a072");
  nc.ui.bd.supplier.stock.SupStockBatchUpdateTab bean = new nc.ui.bd.supplier.stock.SupStockBatchUpdateTab();
  context.put("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#e9a072",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private java.lang.String getI18nFB_24d95b(){
 if(context.get("nc.ui.uif2.I18nFB#24d95b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#24d95b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#24d95b",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#24d95b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList23(){  List list = new ArrayList();  list.add(getCreateCustAction());  list.add(getAssociCustAction());  list.add(getBatchcreateCustAction());  list.add(getAccessoryAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu_card(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu_card");
  ...
  bean.setName(getI18nFB_13a18ba());
  bean.setCode("AssistantFuncMenu");
...
private java.lang.String getI18nFB_13a18ba(){
 if(context.get("nc.ui.uif2.I18nFB#13a18ba")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#13a18ba");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#13a18ba",bean);  bean.setResDir("common");
  bean.setDefaultValue("辅助功能");
  bean.setResId("UC001-0000137");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#13a18ba",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList26(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_12d738f());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_12d738f(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#12d738f")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#12d738f");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#12d738f",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_fdb911());
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
  bean.setSaveAction(getAssociCustSaveAction());
  bean.setCancelAction(getCancelAction_181450b());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_fdb911(){
 if(context.get("nc.ui.uif2.I18nFB#fdb911")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#fdb911");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#fdb911",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#fdb911",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.actions.CancelAction getCancelAction_181450b(){
 if(context.get("nc.ui.uif2.actions.CancelAction#181450b")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#181450b");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#181450b",bean);
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getCreateVCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("createVCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_1dbe65c());
...
private java.lang.String getI18nFB_1dbe65c(){
 if(context.get("nc.ui.uif2.I18nFB#1dbe65c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1dbe65c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1dbe65c",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1dbe65c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction getCreateCustSaveAction(){
 ...
 return (nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction)context.get("createCustSaveAction");
  ...
  bean.setModel(getCreateViewModel());
  bean.setValidationService(getSupplierValidationService_1f0b989());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.baseinfo.model.SupplierValidationService getSupplierValidationService_1f0b989(){
 if(context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1f0b989")!=null)
 return (nc.ui.bd.supplier.baseinfo.model.SupplierValidationService)context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1f0b989");
  ...
  context.put("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1f0b989",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_124f22a());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_124f22a(){
 if(context.get("nc.ui.uif2.I18nFB#124f22a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#124f22a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#124f22a",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#124f22a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList32(){  List list = new ArrayList();  list.add(getList_baseinfoaddaction());  list.add(getList_baseinfoeditaction());  list.add(getList_baseinfodeleteaction());  list.add(getList_copyaddaction());  list.add(getBatchupdategroupaction());  list.add(getSeparatorAction());  list.add(getList_searchAction());  list.add(getCard_refreshAction());  list.add(getSeparatorAction());  list.add(getAssignActionGroup());  list.add(getBankaccaction());  list.add(getSupaddressAction());  list.add(getCard_approveActionGroup());  list.add(getCard_entireFreezeActionGroup());  list.add(getCard_enableActionGroup());  list.add(getAssistantFuncMenu_card());  list.add(getSeparatorAction());  list.add(getBrowseByOrgAction());  list.add(getOrgvisitAction());  list.add(getAssociateSupPfAction());  list.add(getSeparatorAction());  list.add(getCard_printActionGroup());  list.add(getSeparatorAction());  list.add(getMdmAction());  return list;}

...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryParam_197c083());  list.add(getQueryParam_1dfe8a9());  list.add(getQueryParam_123c1a5());  list.add(getQueryParam_7e590c());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_197c083(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#197c083")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#197c083");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#197c083",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1dfe8a9(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1dfe8a9")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1dfe8a9");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1dfe8a9",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_123c1a5(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#123c1a5")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#123c1a5");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#123c1a5",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_7e590c(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#7e590c")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#7e590c");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#7e590c",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_3a0f9());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_3a0f9(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#3a0f9")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#3a0f9");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#3a0f9",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getHSNode_7ad791());  list.add(getVSNode_5e21e6());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_7ad791(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#7ad791")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#7ad791");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#7ad791",bean);
  bean.setLeft(getCNode_1082c50());
  bean.setRight(getCNode_1954b2e());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1082c50(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1082c50")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1082c50");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1082c50",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1954b2e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1954b2e")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1954b2e");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1954b2e",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_5e21e6(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#5e21e6")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#5e21e6");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#5e21e6",bean);
  bean.setUp(getCNode_de94bd());
  bean.setDown(getVSNode_5e88a9());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_de94bd(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#de94bd")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#de94bd");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#de94bd",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_5e88a9(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#5e88a9")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#5e88a9");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#5e88a9",bean);
  bean.setUp(getCNode_f71a47());
  bean.setDown(getTBNode_c7c139());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_f71a47(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#f71a47")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#f71a47");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#f71a47",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_c7c139(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#c7c139")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#c7c139");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#c7c139",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getCNode_1a83df());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1a83df(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1a83df")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1a83df");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1a83df",bean);
  bean.setName(getI18nFB_de6a62());
...
private java.lang.String getI18nFB_de6a62(){
 if(context.get("nc.ui.uif2.I18nFB#de6a62")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#de6a62");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#de6a62",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#de6a62",product);
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_3d7a04());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_3d7a04(){
 if(context.get("bdqueryActionBaseMediator.created#3d7a04")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#3d7a04");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#3d7a04",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView getBaseinfoListView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView)context.get("baseinfoListView");
  ...
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_159ec8());
...
private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_159ec8(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#159ec8")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#159ec8");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#159ec8",bean);
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView getBaseinfoCardView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView)context.get("baseinfoCardView");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setNodekey("base");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_16b8dc0());
  bean.setExceptionHandler(getExceptionhandler());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_16b8dc0(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#16b8dc0")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#16b8dc0");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#16b8dc0",bean);
  bean.setContainer(getUserdefitemContainer());
...
private List getManagedList11(){  List list = new ArrayList();  list.add(getAddLineAction_274e85());  list.add(getInsertLineAction_940f47());  list.add(getDelLineAction_772077());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_274e85(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#274e85")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#274e85");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#274e85",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_940f47(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#940f47")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#940f47");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#940f47",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_772077(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#772077")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#772077");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#772077",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getAddLineAction_f467f1());  list.add(getInsertLineAction_1d43c3a());  list.add(getDelLineAction_be1843());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_f467f1(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#f467f1")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#f467f1");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#f467f1",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_1d43c3a(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#1d43c3a")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#1d43c3a");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#1d43c3a",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_be1843(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#be1843")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#be1843");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#be1843",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_2b074d(){
 if(context.get("nc.ui.uif2.I18nFB#2b074d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#2b074d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#2b074d",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#2b074d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAction getList_searchAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("list_searchAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_ec598c());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_ec598c(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#ec598c")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#ec598c");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#ec598c",bean);
  bean.setContext(getContext());
...
private List getManagedList19(){  List list = new ArrayList();  list.add(getSupBaseInfoBatchUpdateTab_eb1ab4());  list.add(getSupFinanceBatchUpdateTab_12643cb());  list.add(getSupStockBatchUpdateTab_12d0083());  return list;}

private nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab getSupBaseInfoBatchUpdateTab_eb1ab4(){
 if(context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#eb1ab4")!=null)
 return (nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab)context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#eb1ab4");
  nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab bean = new nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab();
  context.put("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#eb1ab4",bean);
...
private nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab getSupFinanceBatchUpdateTab_12643cb(){
 if(context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12643cb")!=null)
 return (nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab)context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12643cb");
  nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab bean = new nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab();
  context.put("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12643cb",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.stock.SupStockBatchUpdateTab getSupStockBatchUpdateTab_12d0083(){
 if(context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#12d0083")!=null)
 return (nc.ui.bd.supplier.stock.SupStockBatchUpdateTab)context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#12d0083");
  nc.ui.bd.supplier.stock.SupStockBatchUpdateTab bean = new nc.ui.bd.supplier.stock.SupStockBatchUpdateTab();
  context.put("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#12d0083",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu");
  ...
  bean.setName(getI18nFB_17caa7f());
...
private java.lang.String getI18nFB_17caa7f(){
 if(context.get("nc.ui.uif2.I18nFB#17caa7f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#17caa7f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#17caa7f",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#17caa7f",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu_card(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu_card");
  ...
  bean.setName(getI18nFB_19da8d2());
  bean.setCode("AssistantFuncMenu");
...
private java.lang.String getI18nFB_19da8d2(){
 if(context.get("nc.ui.uif2.I18nFB#19da8d2")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#19da8d2");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#19da8d2",bean);  bean.setResDir("common");
  bean.setDefaultValue("辅助功能");
  bean.setResId("UC001-0000137");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#19da8d2",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList26(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_1b6ad44());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_1b6ad44(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1b6ad44")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1b6ad44");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1b6ad44",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_295eb3());
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
  bean.setSaveAction(getAssociCustSaveAction());
  bean.setCancelAction(getCancelAction_87974());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_295eb3(){
 if(context.get("nc.ui.uif2.I18nFB#295eb3")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#295eb3");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#295eb3",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#295eb3",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.actions.CancelAction getCancelAction_87974(){
 if(context.get("nc.ui.uif2.actions.CancelAction#87974")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#87974");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#87974",bean);
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_5daeb0(){
 if(context.get("nc.ui.uif2.I18nFB#5daeb0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#5daeb0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#5daeb0",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#5daeb0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction getCreateCustSaveAction(){
 ...
 return (nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction)context.get("createCustSaveAction");
  ...
  bean.setModel(getCreateViewModel());
  bean.setValidationService(getSupplierValidationService_77bb91());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.baseinfo.model.SupplierValidationService getSupplierValidationService_77bb91(){
 if(context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#77bb91")!=null)
 return (nc.ui.bd.supplier.baseinfo.model.SupplierValidationService)context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#77bb91");
  ...
  context.put("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#77bb91",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_bb4a94());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_bb4a94(){
 if(context.get("nc.ui.uif2.I18nFB#bb4a94")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#bb4a94");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#bb4a94",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#bb4a94",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

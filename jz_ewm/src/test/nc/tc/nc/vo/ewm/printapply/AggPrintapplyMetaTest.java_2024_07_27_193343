...
import nc.vo.ewm.printapply.AggPrintapplyMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggPrintapplyMetaTest extends BaseTestCase {
  AggPrintapplyMeta aggPrintapplyMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggPrintapplyMeta=NCLocator.getInstance().lookup(AggPrintapplyMeta.class);
  }

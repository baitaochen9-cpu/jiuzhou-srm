...
public enum OA2NCfuncRuleEnum {
	...
	OA_getArGatherBill("OA_getArGatherBill", new nc.bs.jzyy.sys.oa.qry.OA_getArGatherBill()),
	/**
	 *收款单回写
	 */

	OA_updateArItems("OA_updateArItems", new nc.bs.jzyy.sys.oa.qry.OA_updateArItems()),
	...
	// 请购单回写审核
	OA_PURCHAUDITFLOW("OA_PURCHAUDITFLOW", new nc.bs.jzyy.sys.oa.out.praybill.OA_PraybillFlow()),
	// 销售订单回写审核

...
public class OA_SaleOrderPlugin {
	...
	public void process(String billltypecode, Object obj, Map<String, Object> otherpms) throws BusinessException {
		AbstractSender4OA sender = new OA_SaleOrderSender();
		...
		try {
			...
			if (resp != null) {		
				...
				if(code.equalsIgnoreCase("PARAM_ERROR")||code.equalsIgnoreCase("SYSTEM_INNER_ERROR")){
					throw new BusinessException("同步失败:" + resp.getString("errMsg"));
				}

...
public class ElectronicSignatureBVO extends SuperVO {
	
/**
*字表主鍵
*/
public java.lang.String pk_electronicsignature_b;
/**
*自定义项1
*/
...
/**
* 属性 pk_electronicsignature_b的Getter方法.属性名：字表主鍵
*  创建日期:2021-3-31
* @return java.lang.String
*/
public java.lang.String getPk_electronicsignature_b() {
return this.pk_electronicsignature_b;
} 

/**
* 属性pk_electronicsignature_b的Setter方法.属性名：字表主鍵
* 创建日期:2021-3-31
* @param newPk_electronicsignature_b java.lang.String
*/
public void setPk_electronicsignature_b ( java.lang.String pk_electronicsignature_b) {
this.pk_electronicsignature_b=pk_electronicsignature_b;
} 
...
/**
* 属性 btnid的Getter方法.属性名：按钮
*  创建日期:2021-3-31
* @return nc.vo.sm.funcreg.ButtonRegVO
*/
...
/**
* 属性btnid的Setter方法.属性名：按钮
* 创建日期:2021-3-31
* @param newBtnid nc.vo.sm.funcreg.ButtonRegVO
*/
...
/**
* 属性btnname的Setter方法.属性名：按钮名称
* 创建日期:2021-3-31
* @param newBtnname java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("riasm.electronicsignature_b");
    }
   }

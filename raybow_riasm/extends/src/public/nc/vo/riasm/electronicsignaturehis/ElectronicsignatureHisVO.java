...
public class ElectronicsignatureHisVO extends SuperVO {
...
*按钮名称
*/
public java.lang.String vbtnname;
/**
*功能节点号
*/
public java.lang.String cfuncode;
/**
*备注
*/
...
/**
* 属性 vbtnname的Getter方法.属性名：按钮名称
*  创建日期:2021-4-9
* @return java.lang.String
*/
public java.lang.String getVbtnname() {
return this.vbtnname;
} 

/**
* 属性vbtnname的Setter方法.属性名：按钮名称
* 创建日期:2021-4-9
* @param newVbtnname java.lang.String
*/
public void setVbtnname ( java.lang.String vbtnname) {
this.vbtnname=vbtnname;
} 
 
/**
* 属性 cfuncode的Getter方法.属性名：功能节点号
*  创建日期:2021-4-9
* @return java.lang.String
*/
public java.lang.String getCfuncode() {
return this.cfuncode;
} 

/**
* 属性cfuncode的Setter方法.属性名：功能节点号
* 创建日期:2021-4-9
* @param newCfuncode java.lang.String
*/
public void setCfuncode ( java.lang.String cfuncode) {
this.cfuncode=cfuncode;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("riasm.electronicsignaturehis");
    }
   }

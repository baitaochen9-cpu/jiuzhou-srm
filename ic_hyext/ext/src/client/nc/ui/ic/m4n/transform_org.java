...
public class transform_org extends AbstractJavaBeanDefinition{
...
public nc.ui.ic.pub.env.ICUIContext getIcUIContext(){
 ...
 return (nc.ui.ic.pub.env.ICUIContext)context.get("icUIContext");
  nc.ui.ic.pub.env.ICUIContext bean = new nc.ui.ic.pub.env.ICUIContext(getContext());  context.put("icUIContext",bean);
...
public nc.ui.ic.pub.handler.ICCloseingCheck getClosingListener(){
 ...
 return (nc.ui.ic.pub.handler.ICCloseingCheck)context.get("ClosingListener");
...
public nc.ui.pubapp.uif2app.view.CardPanelOrgSetterForAllRefMediator getCardPanelOrgSetterForAllRefMediator(){
 ...
 return (nc.ui.pubapp.uif2app.view.CardPanelOrgSetterForAllRefMediator)context.get("cardPanelOrgSetterForAllRefMediator");
  nc.ui.pubapp.uif2app.view.CardPanelOrgSetterForAllRefMediator bean = new nc.ui.pubapp.uif2app.view.CardPanelOrgSetterForAllRefMediator(getCard());  context.put("cardPanelOrgSetterForAllRefMediator",bean);
  bean.setModel(getIcBizModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getCardInterceptor(){
 ...
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("cardInterceptor");
...
public nc.ui.ic.special.model.ICSpeBizEditorModel getIcBizEditorModel(){
 ...
 return (nc.ui.ic.special.model.ICSpeBizEditorModel)context.get("icBizEditorModel");
  nc.ui.ic.special.model.ICSpeBizEditorModel bean = new nc.ui.ic.special.model.ICSpeBizEditorModel(getCard(),getList());  context.put("icBizEditorModel",bean);
...
public nc.ui.ic.m4n.deal.TransformUIProcessorInfo getUIProcesorInfo(){
 if(context.get("UIProcesorInfo")!=null)
 return (nc.ui.ic.m4n.deal.TransformUIProcessorInfo)context.get("UIProcesorInfo");
  nc.ui.ic.m4n.deal.TransformUIProcessorInfo bean = new nc.ui.ic.m4n.deal.TransformUIProcessorInfo();
...
public nc.ui.ic.special.deal.SpePrintProcessor getPrintProcessor(){
 ...
 return (nc.ui.ic.special.deal.SpePrintProcessor)context.get("printProcessor");
...
public nc.ui.ic.special.deal.SpeQueryConditionDLGWrapper getQryDLGInitializer(){
 if(context.get("qryDLGInitializer")!=null)
 return (nc.ui.ic.special.deal.SpeQueryConditionDLGWrapper)context.get("qryDLGInitializer");
  nc.ui.ic.special.deal.SpeQueryConditionDLGWrapper bean = new nc.ui.ic.special.deal.SpeQueryConditionDLGWrapper();
...
public nc.ui.ic.pub.deal.ICBillLazilyLoader getBillLazilyLoader(){
 ...
 return (nc.ui.ic.pub.deal.ICBillLazilyLoader)context.get("billLazilyLoader");
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getCardPanelLazilyLoad_d4e976());  list.add(getListPanelLazilyLoad_2b80fa());  list.add(getActionLazilyLoad_20b5ca());  return list;}

private nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad getCardPanelLazilyLoad_d4e976(){
 if(context.get("nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#d4e976")!=null)
 return (nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad)context.get("nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#d4e976");
  nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad bean = new nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad();
  context.put("nc.ui.pubapp.uif2app.lazilyload.CardPanelLazilyLoad#d4e976",bean);
...
private nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad getListPanelLazilyLoad_2b80fa(){
 if(context.get("nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#2b80fa")!=null)
 return (nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad)context.get("nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#2b80fa");
  nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad bean = new nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad();
  context.put("nc.ui.pubapp.uif2app.lazilyload.ListPanelLazilyLoad#2b80fa",bean);
  bean.setListView(getList());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad getActionLazilyLoad_20b5ca(){
 if(context.get("nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad#20b5ca")!=null)
 return (nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad)context.get("nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad#20b5ca");
  nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad bean = new nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad();
  context.put("nc.ui.pubapp.uif2app.lazilyload.ActionLazilyLoad#20b5ca",bean);
  bean.setModel(getIcBizModel());
...
private List getManagedList1(){  List list = new ArrayList();  list.add(getTemplatePrintAction());  list.add(getTemplatePreviewAction());  return list;}
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryTemplateContainer());  list.add(getTemplateContainer());  list.add(getUserdefitemContainer());  return list;}

public nc.ui.ic.pub.model.ICBizDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.ic.pub.model.ICBizDataManager)context.get("modelDataManager");
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getActionsBar_ActionsBarSeparator_c4f0da());  list.add(getHeadZoomAction());  return list;}

private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_c4f0da(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#c4f0da")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#c4f0da");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#c4f0da",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ic.m4n.view.TransformListView getList(){
 if(context.get("list")!=null)
 return (nc.ui.ic.m4n.view.TransformListView)context.get("list");
  nc.ui.ic.m4n.view.TransformListView bean = new nc.ui.ic.m4n.view.TransformListView();
...
public nc.ui.ic.m4n.view.TransformBizView getCard(){
 if(context.get("card")!=null)
 return (nc.ui.ic.m4n.view.TransformBizView)context.get("card");
  nc.ui.ic.m4n.view.TransformBizView bean = new nc.ui.ic.m4n.view.TransformBizView();
  ...
  bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_1859aef());
...
private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_1859aef(){
 if(context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1859aef")!=null)
 return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1859aef");
  ...
  context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1859aef",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getBodyAddLineAction());  list.add(getBodyInsertLineAction());  list.add(getBodyDelLineAction());  list.add(getBodyCopyLineAction());  list.add(getBodyPasteLineAction());  list.add(getBodyPasteToTailAction());  list.add(getActionsBar_ActionsBarSeparator_7ef2ee());  list.add(getRearrangeRowNoBodyLineAction());  list.add(getActionsBar_ActionsBarSeparator_7eeca4());  list.add(getDefaultBodyZoomAction_e20d7f());  return list;}

private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_7ef2ee(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7ef2ee")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7ef2ee");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7ef2ee",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_7eeca4(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7eeca4")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7eeca4");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#7eeca4",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction getDefaultBodyZoomAction_e20d7f(){
 if(context.get("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#e20d7f")!=null)
 return (nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction)context.get("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#e20d7f");
  nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction bean = new nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction();
  context.put("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#e20d7f",bean);
  bean.setPos(1);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pubapp.uif2app.view.FractionFixMediator getFractionFixMediator(){
 ...
 return (nc.ui.pubapp.uif2app.view.FractionFixMediator)context.get("fractionFixMediator");
  nc.ui.pubapp.uif2app.view.FractionFixMediator bean = new nc.ui.pubapp.uif2app.view.FractionFixMediator(getCard());  context.put("fractionFixMediator",bean);
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList8(){  List list = new ArrayList();  list.add(getQueryParams1());  list.add(getQueryParams2());  list.add(getQueryParams3());  list.add(getQueryParam_1df5cf9());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1df5cf9(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1df5cf9")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1df5cf9");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1df5cf9",bean);
...
private List getManagedList9(){  List list = new ArrayList();  list.add(getUserQueryParams1());  list.add(getUserQueryParams2());  list.add(getUserQueryParams3());  return list;}
...
private List getManagedList10(){  List list = new ArrayList();  list.add(getUserQueryParams1());  list.add(getUserQueryParams2());  list.add(getUserQueryParams3());  return list;}
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getVslist());  list.add(getVscard());  return list;}

public nc.ui.uif2.tangramlayout.node.CNode getCqueryarea(){
 if(context.get("cqueryarea")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("cqueryarea");
...
public nc.ui.uif2.tangramlayout.node.VSNode getVscard(){
 ...
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("vscard");
  ...
  bean.setUp(getCNode_984376());
  bean.setDown(getCNode_a901f6());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_984376(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#984376")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#984376");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#984376",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_a901f6(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#a901f6")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#a901f6");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#a901f6",bean);
  bean.setName(getI18nFB_74fd69());
...
private java.lang.String getI18nFB_74fd69(){
 if(context.get("nc.ui.uif2.I18nFB#74fd69")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#74fd69");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#74fd69",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#74fd69",product);
...
public nc.ui.uif2.tangramlayout.node.VSNode getVslist(){
 ...
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("vslist");
  ...
  bean.setUp(getCNode_1bfdd9d());
  bean.setDown(getCNode_c69d3d());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1bfdd9d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1bfdd9d")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1bfdd9d");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1bfdd9d",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_c69d3d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#c69d3d")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#c69d3d");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#c69d3d",bean);
  bean.setName(getI18nFB_16e943e());
...
private java.lang.String getI18nFB_16e943e(){
 if(context.get("nc.ui.uif2.I18nFB#16e943e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#16e943e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#16e943e",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#16e943e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.ic.special.action.SpecialAddAction getAddAction(){
 ...
 return (nc.ui.ic.special.action.SpecialAddAction)context.get("addAction");
  nc.ui.ic.special.action.SpecialAddAction bean = new nc.ui.ic.special.action.SpecialAddAction();
  context.put("addAction",bean);
  bean.setModel(getIcBizModel());
  bean.setEditorModel(getIcBizEditorModel());
  bean.setInterceptor(getCompositeActionInterceptor_4744f3());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor getCompositeActionInterceptor_4744f3(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#4744f3")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#4744f3");
  ...
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#4744f3",bean);
...
private List getManagedList13(){  List list = new ArrayList();  list.add(getCardInterceptor());  return list;}
...
public nc.ui.ic.pf.action.PFApproveStatusInfoActionForIC getApprovingStatusAction(){
 ...
 return (nc.ui.ic.pf.action.PFApproveStatusInfoActionForIC)context.get("approvingStatusAction");
...
public nc.ui.ic.m4n.action.EditActionFor4N getEditAction(){
 if(context.get("editAction")!=null)
 return (nc.ui.ic.m4n.action.EditActionFor4N)context.get("editAction");
  nc.ui.ic.m4n.action.EditActionFor4N bean = new nc.ui.ic.m4n.action.EditActionFor4N();
...
public nc.ui.ic.special.action.SpecialSaveAction getSaveAction(){
 ...
 return (nc.ui.ic.special.action.SpecialSaveAction)context.get("saveAction");
...
public nc.ui.ic.special.action.SpecialDeleteAction getDeleteAction(){
 ...
 return (nc.ui.ic.special.action.SpecialDeleteAction)context.get("deleteAction");
...
public nc.ui.ic.special.action.SpecialCopyAction getCopyAction(){
 if(context.get("copyAction")!=null)
 return (nc.ui.ic.special.action.SpecialCopyAction)context.get("copyAction");
  nc.ui.ic.special.action.SpecialCopyAction bean = new nc.ui.ic.special.action.SpecialCopyAction();
...
public nc.ui.ic.special.action.SpecialQueryAction getQueryAction(){
 ...
 return (nc.ui.ic.special.action.SpecialQueryAction)context.get("queryAction");
...
public nc.ui.ic.special.action.SpecialRefreshAction getRefreshAction(){
 ...
 return (nc.ui.ic.special.action.SpecialRefreshAction)context.get("refreshAction");
...
public nc.ui.ic.special.action.SpecialRefreshCardAction getRefreshCardAction(){
 ...
 return (nc.ui.ic.special.action.SpecialRefreshCardAction)context.get("refreshCardAction");
...
public nc.ui.ic.special.action.SpecialCancelAction getCancelAction(){
 ...
 return (nc.ui.ic.special.action.SpecialCancelAction)context.get("cancelAction");
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getCommitAction());  list.add(getUnCommitAction());  return list;}

public nc.ui.ic.special.action.SpecialCommitAction getCommitAction(){
 if(context.get("commitAction")!=null)
 return (nc.ui.ic.special.action.SpecialCommitAction)context.get("commitAction");
...
public nc.ui.ic.special.action.SpecialSaveCommitAction getSavecommitAction(){
 ...
 return (nc.ui.ic.special.action.SpecialSaveCommitAction)context.get("savecommitAction");
  nc.ui.ic.special.action.SpecialSaveCommitAction bean = new nc.ui.ic.special.action.SpecialSaveCommitAction(getSaveAction(),getCommitAction());  context.put("savecommitAction",bean);
  bean.setModel(getIcBizModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ic.special.action.SpecialUnCommitAction getUnCommitAction(){
 ...
 return (nc.ui.ic.special.action.SpecialUnCommitAction)context.get("unCommitAction");
...
private List getManagedList15(){  List list = new ArrayList();  list.add(getApproveAction());  list.add(getUnApproveAction());  list.add(getSeparatorAction_ffe407());  list.add(getApprovingStatusAction());  return list;}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_ffe407(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#ffe407")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#ffe407");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#ffe407",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ic.special.action.SpecialApproveAction getApproveAction(){
 ...
 return (nc.ui.ic.special.action.SpecialApproveAction)context.get("approveAction");
...
public nc.ui.ic.special.action.SpecialUnApproveAction getUnApproveAction(){
 ...
 return (nc.ui.ic.special.action.SpecialUnApproveAction)context.get("unApproveAction");
...
public nc.ui.ic.special.action.SpecialLinkQueryAction getLinkQryAction(){
 ...
 return (nc.ui.ic.special.action.SpecialLinkQueryAction)context.get("linkQryAction");
...
public nc.ui.ic.special.action.SpecialOnhandnumQueryAction getOnhandnumQryAction(){
 ...
 return (nc.ui.ic.special.action.SpecialOnhandnumQueryAction)context.get("onhandnumQryAction");
...
private java.lang.String getI18nFB_e4199c(){
 if(context.get("nc.ui.uif2.I18nFB#e4199c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#e4199c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#e4199c",bean);  bean.setResDir("4008001_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#e4199c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList16(){  List list = new ArrayList();  list.add(getLinkQryAction());  list.add(getDisplayOrhideAction());  return list;}
...
private List getManagedList17(){  List list = new ArrayList();  list.add(getTemplatePrintAction());  list.add(getTemplatePreviewAction());  list.add(getOutputAction());  list.add(getPrintCountQueryAction());  return list;}

public nc.ui.pubapp.uif2app.actions.BodyAddLineAction getBodyAddLineAction(){
 if(context.get("bodyAddLineAction")!=null)
 return (nc.ui.pubapp.uif2app.actions.BodyAddLineAction)context.get("bodyAddLineAction");
...
public nc.ui.pubapp.uif2app.actions.BodyInsertLineAction getBodyInsertLineAction(){
 ...
 return (nc.ui.pubapp.uif2app.actions.BodyInsertLineAction)context.get("bodyInsertLineAction");
...
private List getManagedList18(){  List list = new ArrayList();  list.add("cspecialbid");  list.add("ts");  return list;}
...
private List getManagedList19(){  List list = new ArrayList();  list.add("cgeneralbid");  list.add("ts");  return list;}
...
public nc.ui.ic.special.action.QueryOnhandForSpecialAction getDisplayOrhideAction(){
 ...
 return (nc.ui.ic.special.action.QueryOnhandForSpecialAction)context.get("displayOrhideAction");
...
public nc.ui.ic.special.action.SpecialAttachmentAction getAttachMentMngAction(){
 ...
 return (nc.ui.ic.special.action.SpecialAttachmentAction)context.get("attachMentMngAction");
...
public nc.ui.ic.special.action.SpecialMDPreviewAction getTemplatePreviewAction(){
 ...
 return (nc.ui.ic.special.action.SpecialMDPreviewAction)context.get("templatePreviewAction");
...
public nc.ui.ic.special.action.SpecialMDPrintAction getTemplatePrintAction(){
 ...
 return (nc.ui.ic.special.action.SpecialMDPrintAction)context.get("templatePrintAction");
...
public nc.ui.pubapp.billref.dest.TransferViewProcessor getTransferViewProcessor(){
 ...
 return (nc.ui.pubapp.billref.dest.TransferViewProcessor)context.get("transferViewProcessor");
  ...
  bean.setTransferLogic(getDefaultBillDataLogic_bfab1a());
...
private nc.ui.pubapp.billref.dest.DefaultBillDataLogic getDefaultBillDataLogic_bfab1a(){
 if(context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#bfab1a")!=null)
 return (nc.ui.pubapp.billref.dest.DefaultBillDataLogic)context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#bfab1a");
  nc.ui.pubapp.billref.dest.DefaultBillDataLogic bean = new nc.ui.pubapp.billref.dest.DefaultBillDataLogic();
  context.put("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#bfab1a",bean);
  bean.setBillForm(getCard());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ic.pub.handler.Pk_orgHandler getPk_orgHandler(){
 ...
 return (nc.ui.ic.pub.handler.Pk_orgHandler)context.get("pk_orgHandler");
...
public nc.ui.ic.pub.handler.CwhsmanageridHandlerHandler getCwhsmanageridHandler(){
 ...
 return (nc.ui.ic.pub.handler.CwhsmanageridHandlerHandler)context.get("cwhsmanageridHandler");
...
public nc.ui.ic.m4n.handler.CmaterialvidHandlerFor4N getCmaterialvidHandler(){
 if(context.get("cmaterialvidHandler")!=null)
 return (nc.ui.ic.m4n.handler.CmaterialvidHandlerFor4N)context.get("cmaterialvidHandler");
  nc.ui.ic.m4n.handler.CmaterialvidHandlerFor4N bean = new nc.ui.ic.m4n.handler.CmaterialvidHandlerFor4N();
...
public nc.ui.ic.special.handler.CastunitidHandler getCastunitidHandler(){
 ...
 return (nc.ui.ic.special.handler.CastunitidHandler)context.get("castunitidHandler");
...
public nc.ui.ic.special.handler.NumHandler getNumHandler(){
 ...
 return (nc.ui.ic.special.handler.NumHandler)context.get("numHandler");
...
public nc.ui.ic.special.handler.MainNumHandler getMainNumHandler(){
 ...
 return (nc.ui.ic.special.handler.MainNumHandler)context.get("mainNumHandler");
...
public nc.ui.ic.special.handler.NgrossNumHandler getNgrossNumHandler(){
 ...
 return (nc.ui.ic.special.handler.NgrossNumHandler)context.get("ngrossNumHandler");
...
public nc.ui.ic.pub.handler.CrownoHandler getCrownoHandler(){
 ...
 return (nc.ui.ic.pub.handler.CrownoHandler)context.get("crownoHandler");
...
public nc.ui.ic.special.handler.VchangerateHandler getVchangerateHandler(){
 ...
 return (nc.ui.ic.special.handler.VchangerateHandler)context.get("vchangerateHandler");
...
public nc.ui.ic.special.handler.NCostpriceHandler getNcostPriceHandler(){
 ...
 return (nc.ui.ic.special.handler.NCostpriceHandler)context.get("ncostPriceHandler");
...
public nc.ui.ic.special.handler.NCostmnyHandler getNcostmnyHandler(){
 ...
 return (nc.ui.ic.special.handler.NCostmnyHandler)context.get("ncostmnyHandler");
...
public nc.ui.ic.special.handler.VbatchcodeHandlerForSpecial getVbatchcodeHandler(){
 if(context.get("vbatchcodeHandler")!=null)
 return (nc.ui.ic.special.handler.VbatchcodeHandlerForSpecial)context.get("vbatchcodeHandler");
  nc.ui.ic.special.handler.VbatchcodeHandlerForSpecial bean = new nc.ui.ic.special.handler.VbatchcodeHandlerForSpecial();
...
public nc.ui.ic.special.handler.CstateidHandler getCstateidHandler(){
 ...
 return (nc.ui.ic.special.handler.CstateidHandler)context.get("cstateidHandler");
...
public nc.ui.ic.special.handler.CtrantypeidHandler getCtrantypeidHandler(){
 ...
 return (nc.ui.ic.special.handler.CtrantypeidHandler)context.get("ctrantypeidHandler");
...
private Map getManagedMap0(){  Map map = new HashMap();  map.put("cbizid",getCbizidHandler());  map.put("cwhsmanagerid",getCwhsmanageridHandler());  map.put("cmaterialvid",getCmaterialvidHandler());  map.put("castunitid",getCastunitidHandler());  map.put("vchangerate",getVchangerateHandler());  map.put("nassistnum",getNumHandler());  map.put("nnum",getMainNumHandler());  map.put("crowno",getCrownoHandler());  map.put("ncostprice",getNcostPriceHandler());  map.put("ncostmny",getNcostmnyHandler());  map.put("vbatchcode",getVbatchcodeHandler());  map.put("cstateid",getCstateidHandler());  map.put("ctrantypeid",getCtrantypeidHandler());  map.put("ngrossnum",getNgrossNumHandler());  map.put("cdptvid",getCdptvidHandler());  return map;}
...
private Map getManagedMap1(){  Map map = new HashMap();  map.put("coutbsor",getCoutbsorHandler());  map.put("cffileid",getCffileidHandler());  map.put("cinbsrid",getCinbsridHandler());  map.put("nassistnum",getNumHandler());  map.put("nnum",getMainNumHandler());  map.put("vbatchcode",getVbatchcodeHandler());  map.put("cstateid",getCstateidHandler());  return map;}
...
public nc.ui.ic.pub.handler.card.ICCardEditEventHandlerMediator getCardEditEventHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardEditEventHandlerMediator)context.get("cardEditEventHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodySortEventHandler getCardBodySortHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodySortEventHandler)context.get("cardBodySortHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodySortEventHandlerMediator getCardBodySortEventHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodySortEventHandlerMediator)context.get("cardBodySortEventHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodyMenuActionEventHandler getCardBodyMenuActionHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyMenuActionEventHandler)context.get("cardBodyMenuActionHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodyMenuActionEventHandlerMediator getCardBodyMenuActionHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyMenuActionEventHandlerMediator)context.get("cardBodyMenuActionHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodyRowChangedEventHandler getCardBodyRowChangedHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyRowChangedEventHandler)context.get("cardBodyRowChangedHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodyRowChangedEventHandlerMediator getCardBodyRowChangedHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyRowChangedEventHandlerMediator)context.get("cardBodyRowChangedHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodyRowEditEventHandler getCardBodyRowEditHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyRowEditEventHandler)context.get("cardBodyRowEditHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodyRowEditEventHandlerMediator getCardBodyRowEditHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyRowEditEventHandlerMediator)context.get("cardBodyRowEditHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodyTabChangedEventHandler getCardBodyTabChangedHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyTabChangedEventHandler)context.get("cardBodyTabChangedHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodyTabChangedEventHandlerMediator getCardBodyTabChangedHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyTabChangedEventHandlerMediator)context.get("cardBodyTabChangedHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardBodyTotalEventHandler getCardBodyTotalHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyTotalEventHandler)context.get("cardBodyTotalHandler");
...
public nc.ui.ic.pub.handler.card.ICCardBodyTotalEventHandlerMediator getCardBodyTotalHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardBodyTotalEventHandlerMediator)context.get("cardBodyTotalHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardPanelLoadEventHandler getCardPanelLoadHandler(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardPanelLoadEventHandler)context.get("cardPanelLoadHandler");
...
public nc.ui.ic.pub.handler.card.ICCardPanelLoadEventHandlerMediator getCardPanelLoadHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardPanelLoadEventHandlerMediator)context.get("cardPanelLoadHandlerMediator");
...
public nc.ui.ic.pub.handler.card.ICCardLoadDataEventHandlerMediator getCardLoadDataHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.card.ICCardLoadDataEventHandlerMediator)context.get("cardLoadDataHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListSortEventHandler getListSortHandler(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListSortEventHandler)context.get("listSortHandler");
...
public nc.ui.ic.pub.handler.list.ICListSortEventHandlerMediator getListSortHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListSortEventHandlerMediator)context.get("listSortHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListDoubleClickEventHandler getListDoubleClickHandler(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListDoubleClickEventHandler)context.get("listDoubleClickHandler");
...
public nc.ui.ic.pub.handler.list.ICListDoubleClickEventHandlerMediator getListDoubleClickHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListDoubleClickEventHandlerMediator)context.get("listDoubleClickHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListRowChangedEventHandler getListRowChangedHandler(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListRowChangedEventHandler)context.get("listRowChangedHandler");
...
public nc.ui.ic.pub.handler.list.ICListRowChangedEventHandlerMediator getListRowChangedHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListRowChangedEventHandlerMediator)context.get("listRowChangedHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListBodyTotalEventHandler getListBodyTotalHandler(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListBodyTotalEventHandler)context.get("listBodyTotalHandler");
...
public nc.ui.ic.pub.handler.list.ICListBodyTotalEventHandlerMediator getListBodyTotalHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListBodyTotalEventHandlerMediator)context.get("listBodyTotalHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListPanelLoadEventHandler getListPanelLoadEventHandler(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListPanelLoadEventHandler)context.get("listPanelLoadEventHandler");
...
public nc.ui.ic.pub.handler.list.ICListPanelLoadEventHandlerMediator getListPanelLoadEventHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListPanelLoadEventHandlerMediator)context.get("listPanelLoadEventHandlerMediator");
...
public nc.ui.ic.pub.handler.list.ICListLoadDataEventHandlerMediator getListLoadDataEventHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.list.ICListLoadDataEventHandlerMediator)context.get("listLoadDataEventHandlerMediator");
...
public nc.ui.ic.pub.handler.ICUiStateChangeEventHandler getIcUiStateChangeEventHandler(){
 ...
 return (nc.ui.ic.pub.handler.ICUiStateChangeEventHandler)context.get("icUiStateChangeEventHandler");
...
public nc.ui.ic.pub.handler.ICUiStateChangeEventHandlerMediator getIcUiStateChangeEventHandlerMediator(){
 ...
 return (nc.ui.ic.pub.handler.ICUiStateChangeEventHandlerMediator)context.get("icUiStateChangeEventHandlerMediator");
...
private Map getManagedMap2(){  Map map = new HashMap();  map.put("nc.ui.pubapp.uif2app.event.OrgChangedEvent",getManagedList20());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent",getManagedList21());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent",getManagedList22());  map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent",getManagedList23());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterEditEvent",getManagedList24());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeBatchEditEvent",getManagedList25());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeSortEvent",getManagedList26());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterSortEvent",getManagedList27());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyMenuActionEvent",getManagedList28());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowChangedEvent",getManagedList29());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowEditEvent",getManagedList30());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyTabChangedEvent",getManagedList31());  map.put("nc.ui.pubapp.uif2app.event.card.CardBodyTotalEvent",getManagedList32());  map.put("nc.ui.pubapp.uif2app.event.card.CardPanelLoadEvent",getManagedList33());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadBeforeSortEvent",getManagedList34());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadAfterSortEvent",getManagedList35());  map.put("nc.ui.pubapp.uif2app.event.list.ListBodyBeforeSortEvent",getManagedList36());  map.put("nc.ui.pubapp.uif2app.event.list.ListBodyAfterSortEvent",getManagedList37());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadDoubleClickEvent",getManagedList38());  map.put("nc.ui.pubapp.uif2app.event.list.ListBodyDoubleClickEvent",getManagedList39());  map.put("nc.ui.pubapp.uif2app.event.list.ListHeadRowChangedEvent",getManagedList40());  map.put("nc.ui.pubapp.uif2app.event.list.ListBodyRowChangedEvent",getManagedList41());  map.put("nc.ui.pubapp.uif2app.event.list.ListBodyTotalEvent",getManagedList42());  map.put("nc.ui.pubapp.uif2app.event.list.ListPanelLoadEvent",getManagedList43());  map.put("nc.ui.pubapp.uif2app.event.AppUiStateChangeEvent",getManagedList44());  return map;}

private List getManagedList20(){  List list = new ArrayList();  list.add(getPk_orgHandler());  return list;}

private List getManagedList21(){  List list = new ArrayList();  list.add(getCardEditEventHandlerMediator());  return list;}

private List getManagedList22(){  List list = new ArrayList();  list.add(getCardEditEventHandlerMediator());  return list;}

private List getManagedList23(){  List list = new ArrayList();  list.add(getCardEditEventHandlerMediator());  return list;}

private List getManagedList24(){  List list = new ArrayList();  list.add(getCardEditEventHandlerMediator());  return list;}

private List getManagedList25(){  List list = new ArrayList();  list.add(getCardEditEventHandlerMediator());  return list;}

private List getManagedList26(){  List list = new ArrayList();  list.add(getCardBodySortEventHandlerMediator());  return list;}

private List getManagedList27(){  List list = new ArrayList();  list.add(getCardBodySortEventHandlerMediator());  return list;}

private List getManagedList28(){  List list = new ArrayList();  list.add(getCardBodyMenuActionHandlerMediator());  return list;}

private List getManagedList29(){  List list = new ArrayList();  list.add(getCardBodyRowChangedHandlerMediator());  return list;}

private List getManagedList30(){  List list = new ArrayList();  list.add(getCardBodyRowEditHandlerMediator());  return list;}

private List getManagedList31(){  List list = new ArrayList();  list.add(getCardBodyTabChangedHandlerMediator());  return list;}

private List getManagedList32(){  List list = new ArrayList();  list.add(getCardBodyTotalHandlerMediator());  return list;}

private List getManagedList33(){  List list = new ArrayList();  list.add(getCardPanelLoadHandlerMediator());  return list;}

private List getManagedList34(){  List list = new ArrayList();  list.add(getListSortHandlerMediator());  return list;}

private List getManagedList35(){  List list = new ArrayList();  list.add(getListSortHandlerMediator());  return list;}

private List getManagedList36(){  List list = new ArrayList();  list.add(getListSortHandlerMediator());  return list;}

private List getManagedList37(){  List list = new ArrayList();  list.add(getListSortHandlerMediator());  return list;}

private List getManagedList38(){  List list = new ArrayList();  list.add(getListDoubleClickHandlerMediator());  return list;}

private List getManagedList39(){  List list = new ArrayList();  list.add(getListDoubleClickHandlerMediator());  return list;}

private List getManagedList40(){  List list = new ArrayList();  list.add(getListRowChangedHandlerMediator());  return list;}

private List getManagedList41(){  List list = new ArrayList();  list.add(getListRowChangedHandlerMediator());  return list;}

private List getManagedList42(){  List list = new ArrayList();  list.add(getListBodyTotalHandlerMediator());  return list;}

private List getManagedList43(){  List list = new ArrayList();  list.add(getListPanelLoadEventHandlerMediator());  return list;}

private List getManagedList44(){  List list = new ArrayList();  list.add(getIcUiStateChangeEventHandlerMediator());  return list;}
...
public nc.ui.uif2.userdefitem.QueryParam getQueryParams1(){
 ...
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("queryParams1");
  ...
  bean.setMdfullname("ic.TransformHeadVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.uif2.userdefitem.QueryParam getQueryParams2(){
 ...
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("queryParams2");
  ...
  bean.setMdfullname("ic.TransformBodyVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ic.special.model.ICSpeBizModel getIcBizModel(){
 ...
 return (nc.ui.ic.special.model.ICSpeBizModel)context.get("icBizModel");
...
public nc.ui.ic.m4n.model.TransformModelService getManageModelService(){
 if(context.get("manageModelService")!=null)
 return (nc.ui.ic.m4n.model.TransformModelService)context.get("manageModelService");
  nc.ui.ic.m4n.model.TransformModelService bean = new nc.ui.ic.m4n.model.TransformModelService();
...
public nc.ui.ic.m4n.action.GenerateInAndOut getGenerateInAndOut(){
 if(context.get("generateInAndOut")!=null)
 return (nc.ui.ic.m4n.action.GenerateInAndOut)context.get("generateInAndOut");
  nc.ui.ic.m4n.action.GenerateInAndOut bean = new nc.ui.ic.m4n.action.GenerateInAndOut();
  context.put("generateInAndOut",bean);
  bean.setEditorModel(getIcBizEditorModel());
...
public nc.funcnode.ui.action.MenuAction getRelationGroupAction(){
 if(context.get("relationGroupAction")!=null)
 return (nc.funcnode.ui.action.MenuAction)context.get("relationGroupAction");
  nc.funcnode.ui.action.MenuAction bean = new nc.funcnode.ui.action.MenuAction();
  context.put("relationGroupAction",bean);
  bean.setCode("relationGroupAction");
  bean.setName(getI18nFB_14d61a2());
...
private java.lang.String getI18nFB_14d61a2(){
 if(context.get("nc.ui.uif2.I18nFB#14d61a2")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#14d61a2");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#14d61a2",bean);  bean.setResDir("4008001_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#14d61a2",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList45(){  List list = new ArrayList();  list.add(getGenerateInAndOut());  return list;}
...
private List getManagedList46(){  List list = new ArrayList();  list.add(getActionsOfList());  list.add(getActionsOfCard());  return list;}
...
private List getManagedList47(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getSeparatorAction_145038f());  list.add(getQueryAction());  list.add(getRefreshAction());  list.add(getSeparatorAction_1eccaf8());  list.add(getCommitActionMenu());  list.add(getApproveActionMenu());  list.add(getSeparatorAction_10164df());  list.add(getLinkQryBrowseGroupAction());  list.add(getSeparatorAction_85794c());  list.add(getRelationGroupAction());  list.add(getSeparatorAction_de8263());  list.add(getPrintMngAction());  return list;}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_145038f(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#145038f")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#145038f");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#145038f",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1eccaf8(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1eccaf8")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1eccaf8");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1eccaf8",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_10164df(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#10164df")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#10164df");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#10164df",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_85794c(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#85794c")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#85794c");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#85794c",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_de8263(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#de8263")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#de8263");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#de8263",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private List getManagedList48(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getSeparatorAction_424270());  list.add(getQueryAction());  list.add(getRefreshCardAction());  list.add(getSeparatorAction_1800a4());  list.add(getCommitActionMenu());  list.add(getApproveActionMenu());  list.add(getSeparatorAction_1d21636());  list.add(getLinkQryBrowseGroupAction());  list.add(getSeparatorAction_1b05916());  list.add(getRelationGroupAction());  list.add(getSeparatorAction_a8f4d8());  list.add(getPrintMngAction());  return list;}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_424270(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#424270")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#424270");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#424270",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1800a4(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1800a4")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1800a4");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1800a4",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1d21636(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1d21636")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1d21636");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1d21636",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1b05916(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1b05916")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1b05916");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1b05916",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_a8f4d8(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#a8f4d8")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#a8f4d8");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#a8f4d8",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private List getManagedList49(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_629a7a());  list.add(getSavecommitAction());  list.add(getSeparatorAction_18bc904());  list.add(getCancelAction());  list.add(getSeparatorAction_3a297a());  list.add(getLinkQryBrowseGroupAction());  return list;}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_629a7a(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#629a7a")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#629a7a");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#629a7a",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_18bc904(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#18bc904")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#18bc904");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#18bc904",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.funcnode.ui.action.SeparatorAction getSeparatorAction_3a297a(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#3a297a")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#3a297a");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#3a297a",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ic.general.handler.CffileidHandler getCffileidHandler(){
 ...
 return (nc.ui.ic.general.handler.CffileidHandler)context.get("cffileidHandler");
...
public nc.ui.ic.m4n.handler.CoutbsorHandler getCoutbsorHandler(){
 if(context.get("coutbsorHandler")!=null)
 return (nc.ui.ic.m4n.handler.CoutbsorHandler)context.get("coutbsorHandler");
  nc.ui.ic.m4n.handler.CoutbsorHandler bean = new nc.ui.ic.m4n.handler.CoutbsorHandler();
  context.put("coutbsorHandler",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.ic.m4p.handler.CinbsridHandler getCinbsridHandler(){
 if(context.get("cinbsridHandler")!=null)
 return (nc.ui.ic.m4p.handler.CinbsridHandler)context.get("cinbsridHandler");
  nc.ui.ic.m4p.handler.CinbsridHandler bean = new nc.ui.ic.m4p.handler.CinbsridHandler();
  context.put("cinbsridHandler",bean);
  bean.setEditorModel(getIcBizEditorModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pubapp.uif2app.model.DefaultFuncNodeInitDataListener getInitDataListener(){
 ...
 return (nc.ui.pubapp.uif2app.model.DefaultFuncNodeInitDataListener)context.get("InitDataListener");
  ...
  bean.setModel(getIcBizModel());
  bean.setVoClassName("nc.vo.ic.m4n.entity.TransformVO");
...
private Map getManagedMap3(){  Map map = new HashMap();  map.put("101",getSpeBillInitDataProcessor_793f12());  return map;}

private nc.ui.ic.special.deal.SpeBillInitDataProcessor getSpeBillInitDataProcessor_793f12(){
 if(context.get("nc.ui.ic.special.deal.SpeBillInitDataProcessor#793f12")!=null)
 return (nc.ui.ic.special.deal.SpeBillInitDataProcessor)context.get("nc.ui.ic.special.deal.SpeBillInitDataProcessor#793f12");
  nc.ui.ic.special.deal.SpeBillInitDataProcessor bean = new nc.ui.ic.special.deal.SpeBillInitDataProcessor();
  context.put("nc.ui.ic.special.deal.SpeBillInitDataProcessor#793f12",bean);
  bean.setModel(getIcBizModel());
  bean.setAutoShowUpComponent(getCard());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);

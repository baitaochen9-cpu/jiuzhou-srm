 ...
 * @version 1.0
 */
public class ElectronicsignatureHisDialog extends UIDialog implements BillEditListener,
		BillEditListener2 {

	private static final long serialVersionUID = 5064747027574608058L;
	private BillListPanel parent;
	...
	public ElectronicsignatureHisDialog(BillListPanel parent,AbstractAppModel model) {
		super(parent);
		this.parent = parent;
		this.model=model;
		this.initialize();
...
//			SYSTEM	采购结算单表头(补录)	1001A110000000C8SCPW
			this.billPanel.loadTemplet("0001ZZ1000000000P7O0");
...
//					.getName());
	...
	class ActionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == ElectronicsignatureHisDialog.this.getBtnDelLine()) {

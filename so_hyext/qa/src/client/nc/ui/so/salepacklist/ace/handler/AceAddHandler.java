package nc.ui.so.salepacklist.ace.handler;
...
public class AceAddHandler implements IAppEventHandler<AddEvent> {
	...
	public void handleAppEvent(AddEvent e) {
		...
		panel.setHeadItem("dbilldate", new UFDate(System.currentTimeMillis()));
		panel.setHeadItem("billtype", "4345");
		panel.setHeadItem("transtype", "4345");
		panel.setHeadItem("transtypepk",
				PfServiceScmUtil.getTrantypeidByCode(new String[] { "4345" })
						.get("4345"));
